...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.isButton()) {
    ...
    if(interaction.customId === "tylenol") {
      ...
      receivedEmbed2.fields.find(f => f.name === "Next dose").value = `>>> Motrin <t:${time + 1000 * 60 * 3}>`
    ...
    if(interaction.customId === "motrin") {
      ...
      receivedEmbed2.fields.find(f => f.name === "Time taken").value = `>>> <t:${time}>`
      receivedEmbed2.fields.find(f => f.name === "Next dose").value = `>>> Tylenol <t:${time + 1000 * 60 * 3}>`
